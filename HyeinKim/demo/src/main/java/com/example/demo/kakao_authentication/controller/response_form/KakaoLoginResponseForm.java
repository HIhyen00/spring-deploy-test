package com.example.demo.kakao_authentication.controller.response_form;
...
public class KakaoLoginResponseForm {
    ...
    public static KakaoLoginResponseForm from(KakaoUserInfoResponse kakaoUserInfoResponse, String temporaryUserToken) {
